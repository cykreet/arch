...
public enum Message {
	INTERNAL_WEBHOOK_NOT_CREATED("Manageable webhook has not been created, try reloading the plugin."),
	INTERNAL_BOT_NOT_IN_SERVER("Discord bot is not in the configured server, please invite the bot through the following link: %s"),
	...
	INTERNAL_BOT_READY("Discord bot \"%s\", is ready."),
